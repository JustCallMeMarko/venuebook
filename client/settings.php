...
<head>
    ...
    <title>VenueBook Settings</title>
</head>

<body class="bgs-primary">
    <div class="container">
        <main class="col-12 col-lg-8 mx-auto pb-4">
            <button class="btn btn-light border border-dark-subtle my-3" onclick="history.back()">
            ...
            <div class="p-4 rounded-3 border border-dark-subtle">
                <section class="mb-4">
