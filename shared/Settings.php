...
<div class="col-12 col-lg-9 p-1 mx-auto">
    ...
    <form class="p-4 rounded-3 border border-dark-subtle" method="POST">
        ...
        <section class="mb-4">
            ...
            <p class="font-open" style="font-size: 14px;">Manage your information details, including your name, email address, and phone number.</p>
        ...
        <div class="d-flex flex-column flex-lg-row gap-2">
            ...
            <a href="/venuebook/actions/logout.php"
                class="btn btn-dark px-4 d-inline-flex align-items-center">
            ...
            <form method="POST" action="/venuebook/shared/delete_account.php" id="deleteForm">
                <button type="button" class="btn btn-danger px-4 d-inline-flex align-items-center"
